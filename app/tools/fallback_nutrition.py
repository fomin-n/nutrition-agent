...
FALLBACK_FOODS: tuple[FallbackFood, ...] = (
    ...
    FallbackFood(
        ...
        0.2,
        10.0,
        ("beet", "beets", "cooked beet", "свекла", "свеклы", "свекле", "свеклой"),
    ),
    FallbackFood(
        "cabbage cooked",
        23,
        ...
        0.1,
        5.5,
        ("cabbage", "cooked cabbage", "капуста", "капусты", "капусте", "капустой"),
    ),
    FallbackFood(
        "carrot cooked",
        35,
        ...
        0.2,
        8.2,
        ("carrot", "carrots", "cooked carrot", "морковь", "моркови", "морковью"),
    ),
    FallbackFood(
        "onion",
        40,
    ...
    FallbackFood(
        ...
        2.0,
        6.5,
        ("borscht", "borsch", "борщ", "борща", "борще", "борщом"),
    ),
    FallbackFood(
