...
- Comparison ID: `golden_lane_comparison_20260624T191451699354Z`
- Fallback run: `golden_baseline_all_20260624T182303844174Z`
- LLM-path run: `golden_baseline_all_20260624T182542176557Z`
...
| `na_golden_090` | `Calories in 250g cottage cheese with honey` | `fail` | `pass` |
...
| `na_golden_028` | `Calories in 100g baguette` | `pass` | `fail` |
